...
./prono
```
By default, the server starts at http://localhost:8080 and serves files from the current directory.
...
Clone & Build
```bash
git clone https://github.com/problox42r/pronoweb.git
cd pronoweb
...
```ini
# prono.ini (not yet implemented in early versions)
port = 8080
root = ./public
...
Happy hacking!
](https://github.com/ProBlox42R/pronoweb)
